const modules = [
  ...
  { 
      id: 4,
      title: "Integrating Financial modelling",
      info: ["An integrated financial model of a company breaks down the financials of a company to give you granular insights. A financial model includes assets, reserves, debt schedules, cashflows, and valuation models. Learn all that and more in this module."],
  ...
  
  {
    ...
    info: ["Risk management is a crucial aspect of trading. Learn how to manage your risk"],
  } , 
  {
    id:6,
    title:"Currency, Commodity, and Government Securities",
    info:["Interest rates, forex rates, and inflation impact each other and commodity prices. Commodity prices impact each other, too. This module discusses trading in currency and commodity derivatives and Government Securities (GSec) in the Indian markets."],
  }
